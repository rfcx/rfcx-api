  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(t => {
      return Promise.all([
        ...
        queryInterface.addColumn('classifiers', 'created_at', { type: Sequelize.DATE(3), allowNull: false, defaultValue: Sequelize.NOW }, { transaction: t }),
        queryInterface.addColumn('classifiers', 'updated_at', { type: Sequelize.DATE(3), allowNull: false, defaultValue: Sequelize.NOW }, { transaction: t })
      ]).then(() => {
