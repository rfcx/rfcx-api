  ...
  .get(passport.authenticate("token",{session:false}), function(req,res) {
        ...
        models.Guardian
          .findOne({ 
            ...
            if ((req.rfcx.ending_before != null) || (req.rfcx.starting_after != null)) { dbQuery.where[modelLookUp[meta_type].timeStampColumn] = {}; }
            if (req.rfcx.ending_before != null) { dbQuery.where[modelLookUp[meta_type].timeStampColumn]["$lt"] = req.rfcx.ending_before; }
            if (req.rfcx.starting_after != null) { dbQuery.where[modelLookUp[meta_type].timeStampColumn]["$gt"] = req.rfcx.starting_after; }
            ...
            if ((req.rfcx.ending_before == null) && (req.rfcx.starting_after == null)) { dbQuery.limit = req.rfcx.limit; }
