...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async transaction => {
      ...
      await queryInterface.removeColumn('classifier_jobs', 'segments_total')
      await queryInterface.removeColumn('classifier_jobs', 'segments_completed')
    })
  },
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async transaction => {
      ...
      await queryInterface.removeColumn('classifier_jobs', 'minutes_total')
      await queryInterface.removeColumn('classifier_jobs', 'minutes_completed')
    })
  }
}
