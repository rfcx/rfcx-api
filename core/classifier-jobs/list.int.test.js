...
describe('GET /classifier-jobs', () => {
  ...
  test('respects query_start 1', async () => {
    ...
    const projectId = PROJECT_1.id
    // Waiting cancel jobs (3)
    const job1 = await models.ClassifierJob.create({ queryStreams: 'stream1', queryStart: '2024-01-01', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
    const job2 = await models.ClassifierJob.create({ queryStreams: 'stream1,stream2', queryStart: '2024-01-02', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
    const job3 = await models.ClassifierJob.create({ queryStreams: 'stream1,stream2,stream3', queryStart: '2024-01-03', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
  ...
  test('respects query_start 2', async () => {
    ...
    const projectId = PROJECT_1.id
    // Waiting cancel jobs (3)
    await models.ClassifierJob.create({ queryStreams: 'stream1', queryStart: '2024-01-01', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
    const job2 = await models.ClassifierJob.create({ queryStreams: 'stream1,stream2', queryStart: '2024-01-02', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
    const job3 = await models.ClassifierJob.create({ queryStreams: 'stream1,stream2,stream3', queryStart: '2024-01-03', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
  ...
  test('respects query_start 3', async () => {
    ...
    // Waiting cancel jobs (3)
    await models.ClassifierJob.create({ queryStreams: 'stream1', queryStart: '2024-01-01', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
    await models.ClassifierJob.create({ queryStreams: 'stream1,stream2', queryStart: '2024-01-02', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
    const job3 = await models.ClassifierJob.create({ queryStreams: 'stream1,stream2,stream3', queryStart: '2024-01-03', status: AWAITING_CANCELLATION, classifierId, projectId, createdById: seedValues.otherUserId })
  ...
  test('respects query_end 1', async () => {
    ...
    expect(response.headers['total-items']).toBe('8')
    expect(response.body[0].id).toBe(job3.id)
    expect(response.body[1].id).toBe(job2.id)
    expect(response.body[2].id).toBe(job1.id)
  })
  ...
  test('respects query_end 2', async () => {
    ...
    expect(response.headers['total-items']).toBe('7')
  ...
  test('respects query_end 3', async () => {
    ...
    expect(response.headers['total-items']).toBe('6')
  ...
  test('respects query_hours 1', async () => {
    ...
    expect(response1.headers['total-items']).toBe('8')
    ...
    expect(response2.headers['total-items']).toBe('8')
    ...
    expect(response3.headers['total-items']).toBe('8')
