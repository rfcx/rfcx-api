...
INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK03', 'Zhenya test private', '2020-01-01T12:00:00.000Z', '2020-01-01T13:00:00.000Z', false, 181, NOW(), NOW()) ON CONFLICT DO NOTHING;
INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK04', 'Zhenya test public', '2020-01-01T13:00:00.000Z', '2020-01-01T14:00:00.000Z', true, 181, NOW(), NOW()) ON CONFLICT DO NOTHING;
...
INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK07', 'Franco test private', '2020-01-01T16:00:00.000Z', '2020-01-01T17:00:00.000Z', false, 270, NOW(), NOW()) ON CONFLICT DO NOTHING;
INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK08', 'Franco test public', '2020-01-01T17:00:00.000Z', '2020-01-01T18:00:00.000Z', true, 270, NOW(), NOW()) ON CONFLICT DO NOTHING;

INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK09', 'Lawrence test private', '2020-01-01T18:00:00.000Z', '2020-01-01T19:00:00.000Z', false, 265, NOW(), NOW()) ON CONFLICT DO NOTHING;
INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK10', 'Lawrence test public', '2020-01-01T19:00:00.000Z', '2020-01-01T20:00:00.000Z', true, 265, NOW(), NOW()) ON CONFLICT DO NOTHING;

INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK11', 'Maria test private', '2020-01-01T18:00:00.000Z', '2020-01-01T19:00:00.000Z', false, 279, NOW(), NOW()) ON CONFLICT DO NOTHING;
INSERT INTO public.streams(id, name, start, "end", is_public, created_by_id, created_at, updated_at) VALUES ('LilSjZJkRK12', 'Maria test public', '2020-01-01T19:00:00.000Z', '2020-01-01T20:00:00.000Z', true, 279, NOW(), NOW()) ON CONFLICT DO NOTHING;
