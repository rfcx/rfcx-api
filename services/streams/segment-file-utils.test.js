...
describe('makeffmpegCmd', () => {
  ...
  describe('Single segment', () => {
    test('Should return correct simple command.', () => {
      ...
      expect(segmentFileUtils.makeffmpegCmd(segments, 1000, 2000, {}, '/tmp/destination.opus')).toEqual(command)
    })
    ...
    describe('"sample_rate" attribute', () => {
      test('Should call console.error if segment does not have sample rate.', () => {
        ...
        segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, {}, '/tmp/test.opus')
      ...
      test('Should return correct command with undefined sample rate.', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, {}, '/tmp/destination.opus')).toEqual(command)
      })
    ...
    describe('gain attribute', () => {
      test('Should return correct command for single segment with gain defined to 0.', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, { gain: 0 }, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for single segment with gain defined to 0.5.', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, { gain: 0.5 }, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for single segment with gain defined to 1.', () => {
        ...
        const command = '/usr/local/bin/ffmpeg -ss 100ms -t 800ms -i /tmp/source.opus -filter_complex "[0:a]aresample=24000[0resampled];[0resampled]concat=n=1:v=0:a=1" -y -vn /tmp/destination.opus'
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, { gain: 1 }, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for single segment with gain defined to 1.5.', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, { gain: 1.5 }, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for single segment with gain defined to 9007199254740991.', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 1900, { gain: 9007199254740991 }, '/tmp/destination.opus')).toEqual(command)
      })
    })
    ...
    describe('Time ranges', () => {
      test('Should return correct command for range which starts before segment and ends with segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 2000, {}, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for range which starts inside segment and ends with segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 2000, {}, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for range which starts before segment and ends inside segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 1900, {}, '/tmp/destination.opus')).toEqual(command)
      })
      ...
      test('Should return correct command for range which starts before segment and ends after segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 2100, {}, '/tmp/destination.opus')).toEqual(command)
      })
    })
  })
  ...
  describe('Two segments', () => {
    test('Should return correct simple command.', () => {
      ...
      expect(segmentFileUtils.makeffmpegCmd(segments, 1000, 3000, {}, '/tmp/destination.opus')).toEqual(command)
    })
    describe('Time ranges', () => {
      test('Should return correct command for range which starts before first segment and ends with second segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 3000, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts inside first segment and ends with second segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 3000, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts before first segment and ends inside second segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 2900, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts inside first segment and ends inside second segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 2900, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts before first segment and ends after second segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 3100, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts inside first segment and ends after second segment', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 3100, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts before first segment, ends after second segment and there is a gap between segments', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 900, 3300, {}, '/tmp/destination.opus')).toEqual(command)
      })
      test('Should return correct command for range which starts inside first segment, ends inside second segment and there is an overlay between segments', () => {
        ...
        expect(segmentFileUtils.makeffmpegCmd(segments, 1100, 2800, {}, '/tmp/destination.opus')).toEqual(command)
      })
    })
  })
})
